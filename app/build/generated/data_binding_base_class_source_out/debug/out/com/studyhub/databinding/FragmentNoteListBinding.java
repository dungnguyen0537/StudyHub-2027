...
public final class FragmentNoteListBinding implements ViewBinding {
  ...
  private FragmentNoteListBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton fabAddNote, @NonNull LinearLayout llEmptyState,
      @NonNull RecyclerView rvNotes, @NonNull SwipeRefreshLayout swipeRefreshLayout) {
  ...
  public static FragmentNoteListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentNoteListBinding((CoordinatorLayout) rootView, fabAddNote, llEmptyState,
          rvNotes, swipeRefreshLayout);
    }
